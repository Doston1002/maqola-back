...
AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            admin_guard_1.OnlyAdminGuard,
            customer_service_1.CustomerService,
            token_blacklist_service_1.TokenBlacklistService,
            user_activity_logger_1.UserActivityLogger,
        ],
        exports: [auth_service_1.AuthService, oneid_service_1.OneIdService, recaptcha_service_1.RecaptchaService, jwt_guard_1.JwtAuthGuard, admin_guard_1.OnlyAdminGuard],
    })
], AuthModule);
